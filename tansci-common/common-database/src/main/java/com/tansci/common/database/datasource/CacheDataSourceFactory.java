...
/**
 * @path：com.tansci.common.database.datasource.CacheDataSourceFactory.java
 * @className：CacheDataSourceFactory.java
 * @description：数据源工厂
 * @author：tanyp
 * @dateTime：2022/06/13 11:33
 * @editNote：
 */
public class CacheDataSourceFactory extends AbstractDataSourceFactory {
