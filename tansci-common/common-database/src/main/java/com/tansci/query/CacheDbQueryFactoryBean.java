package com.tansci.query;

import com.tansci.cache.DefaultSqlCache;
import com.tansci.core.DbColumn;
import com.tansci.core.DbTable;
import com.tansci.core.PageResult;
...
/**
 * @path：com.tansci.query.CacheDbQueryFactoryBean.java
 * @className：CacheDbQueryFactoryBean.java
